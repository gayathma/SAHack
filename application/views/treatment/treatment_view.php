        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="adv-table">
                    <div class="clearfix">
                        <div class="btn-group">
                            <a id="editable-sample_new" class="btn btn-shadow btn-primary" href="#treatment_add_modal" data-toggle="modal">
                                Add New
...
<!--                                <th>Added By</th>
                        ...
                        <tbody>
                            ...
                            foreach ($results as $result) {
                                ?>
                                <tr id="transmission_<?php echo $result->t_id; ?>">
                                    <td><?php echo++$i; ?></td>
                                    <td><?php echo $result->t_name; ?></td>
                                     <td><?php echo $result->t_description; ?></td>
    <!--                                    <td><?php //echo $result->added_by_user; ?></td>
                                    <td><?php// echo $result->added_date; ?></td>-->
                                    <td align="center">
                                        <?php if ($result->t_delete_index=='0') { ?>
                                    ...
                                    <td align="center">
                                        <a class="btn btn-primary btn-xs" onclick="display_edit_treatment(<?php echo $result->t_id; ?>)"><i class="fa fa-pencil"  title="Update"></i></a>
                                        <a class="btn btn-danger btn-xs" onclick="delete_treatment(<?php echo $result->t_id; ?>)"><i class="fa fa-trash-o " title="" title="Remove"></i></a>
...
<div class="modal fade " id="treatment_add_modal" tabindex="-1" role="dialog" aria-labelledby="treatment_add_modal_label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Add New Treatment Type</h4>
            </div>
